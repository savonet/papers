...
etc. (see Section~\ref{sec:content}). Tracks can also contain a very important
...
stream such as track-changes (the moment where a song ends and the next one
...
Being potentially infinite objects, streams are not represented directly and
entirely but actually generated on the fly.
