...
obtaining data from the input sources
which obtain data from their dependent sources, and so on.
...
reference passing mechanism based on \textit{frames}. A frame is an elementary
chunk of data that represents a small portion of the stream. 
An active source instanciates a frame and tries to fill it by passing a reference
