...
together with some new operators,
the enrichment the language (notably with variants and recursion) will 
make it possible to express more things directly in the script
language, bringing more customizability.
...
this would call for an object-oriented extension of our type system.
