...
and the playlist file. The \liquidsoap{} language is interpreted. The evaluation of a script or
expression triggers the construction of a stream processing devices, built by
composing various elementary blocks. The \liquidsoap{} language belongs to the 
familly of ML languages. In this paper, we do not focus on language-specific details
which have been explained extensively in \cite{baelde-mimram:webradio-lambda}.
...
chunk of data that represents a fixed portion of the stream. 
